...
public class ExtractorMapperMethod3Flexible extends
    ...
    protected void map(IntWritable key, TextArrayWritable value, Context context)
        ...
        for (Rule r: re.extract(a, sp)) {
            ...
            PairWritable<RuleWritable, IntWritable> targetCountPair = new PairWritable<RuleWritable, IntWritable>(
                    targetMarginal, one);
    ...
    public static void main(String[] args) throws IOException,
        ...
        ExtractorMapperMethod3Flexible ruleMapper = new ExtractorMapperMethod3Flexible() {
