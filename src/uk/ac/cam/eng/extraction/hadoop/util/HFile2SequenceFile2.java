 ...
 *         to have multiple reducers and keep the data sorted. Unlike
 *         {@link HFile2SequenceFile}, the keys (sources) are repeated as many
 *         times as there are targets per source.
 */
public class HFile2SequenceFile2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        do {
            ...
            int numberOfTargets = value.get().length;
